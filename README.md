...
<ul>
    ...
    <li><strong>📦 Kafka Cluster:</strong> Comprises three controllers and three brokers to manage and distribute the data streams. Kafka automatically creates the required topics (init topcis container) and ensures data flows correctly through the system.</li>
